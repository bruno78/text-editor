	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 // Step 3
			 long begLoop = System.nanoTime();	 
			 for (int i = 0; i < trials; i++) {
				 BasicDocument doc = new BasicDocument(file);
				 doc.getFleschScore();
			 }
			 long endLoop = System.nanoTime();
			 double estTime = (endLoop - begLoop) / 100000000.0;
			 
			 // Step 5
			 long begLoop2 = System.nanoTime();
			 for(int i = 0; i < trials; i++) {
				 EfficientDocument effDoc = new EfficientDocument(file);
				 effDoc.getFleschScore();
			 }
			 long endLoop2 = System.nanoTime();
			 double estTime2 = (endLoop2 - begLoop2) / 100000000.0;
			// Step 1, and 6
			 System.out.println(numToCheck + "\t" + estTime + "\t" + estTime2);
